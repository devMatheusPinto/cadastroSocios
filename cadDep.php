    ...
    <div id="cadastro">
    	<form name="signup" method="post" action="cadastro.php">
    		<table id="tab_cadastro">
            	...
            	<tr>
                	<td>Nome Completo:</td>
                    <td><input type="text" name="nome" required placeholder="Conforme está na identidade" id="nome" class="txt" /></td>
                </tr>

                <tr>    
                    <td>CPF:</td>
                    <td><input type="text" name="cpf" onkeypress="mascaraCpf()" maxlength="11" required placeholder="Somente os números do CPF" id="cpf" class="txt" /></td>
                </tr> 

                <tr>    
                    <td>Identidade:</td>
                    <td><input type="text" name="id" required placeholder="Somente os números da identidade" id="id" class="txt" /></td>
                </tr> 

                <tr>    
                    <td>Órgão emissor:</td>
                    <td><input type="text" name="emissor" required placeholder="Ministério da Marinha, DETRAN-RJ..." id="emissor" class="txt" /></td>
                </tr> 

                <tr>    
                    <td>Telefone:</td>
                    <td><input type="text" name="tel" onkeypress="mascaraCel()" maxlength="11" required placeholder="DDD+Número sem pontuação" id="tel" class="txt" /></td>
                </tr> 
